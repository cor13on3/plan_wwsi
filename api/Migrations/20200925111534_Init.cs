        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Semestr = table.Column<short>(nullable: false),
                    Tryb = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdPrzedmiotu = table.Column<short>(nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdLekcji = table.Column<int>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    CzasOd = table.Column<TimeSpan>(nullable: false),
                    CzasDo = table.Column<TimeSpan>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NrZjazdu = table.Column<short>(nullable: false),
                    IdZjazdu = table.Column<int>(nullable: false),
                    NrGrupy = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GrupaZjazd", x => new { x.NrZjazdu, x.IdZjazdu, x.NrGrupy });
                    table.ForeignKey(
