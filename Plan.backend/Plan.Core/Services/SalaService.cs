...
namespace Plan.Core.Services
{
    public class SalaService : ISalaService
    {
        ...
        public void Dodaj(string nazwa, RodzajSali rodzajSali)
        {
            ...
            _baza.DajRepozytorium<Sala>().Dodaj(new Sala
            {
                Nazwa = nazwa,
                Rodzaj = rodzajSali
            });
        ...
        {
            var wynik = _baza.DajRepozytorium<Sala>().Wybierz(new ZapytanieSale());
            return wynik.ToArray();
        }

        public void Usun(int id)
        {
            IRepozytorium<Sala> repo = _baza.DajRepozytorium<Sala>();
